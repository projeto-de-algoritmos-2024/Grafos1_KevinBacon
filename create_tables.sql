...
CREATE TABLE crew_directors (
    ...
    CONSTRAINT crew_directors_title_principals_FK FOREIGN KEY (tconst) REFERENCES title_principals(tconst),
...
CREATE TABLE crew_writers (
    ...
    CONSTRAINT crew_writers_title_principals_FK FOREIGN KEY (tconst) REFERENCES title_principals(tconst),
